...
* Submit any feature requests on [the Okra.Platform.XamarinForms issue tracker](https://github.com/OkraFramework/Okra.Platform.XamarinForms/issues).
...
* Submit any bug reports on [the Okra.Platform.XamarinForms issue tracker](https://github.com/OkraFramework/Okra.Platform.XamarinForms/issues).
...
* For anything but the most simple changes, please add a feature request or bug report to [the issue tracker](https://github.com/OkraFramework/Okra.Platform.XamarinForms/issues) stating that you would be interested in contributing. This lets the Okra Framework team and the community know you are looking into it, and starts a discussion about the best way to tackle the problem.
